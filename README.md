...
3. [Project Structure](#3-project-structure)  
   1. [Root-Level](#31-root-level)  
   2. [Backend](#32-backend)  
   3. [Frontend](#33-frontend)  
   4. [Uploads](#34-uploads)  
   5. [Testing](#35-testing)  
4. [Backend Architecture & Flow](#4-backend-architecture--flow)  
5. [Frontend Architecture & Flow](#5-frontend-architecture--flow)  
6. [Detailed File Explanations](#6-detailed-file-explanations)  
   1. [Backend Files](#61-backend-files)  
   2. [Frontend Files](#62-frontend-files)  
7. [Environment Variables](#7-environment-variables)  
8. [How to Run Locally](#8-how-to-run-locally)  
9. [Key Workflows](#9-key-workflows)  
   1. [Uploading and Extracting PDF](#91-uploading-and-extracting-pdf)  
   2. [Generating Memo](#92-generating-memo)  
   3. [Validating Selections](#93-validating-selections)  
10. [Extending & Debugging](#10-extending--debugging)
